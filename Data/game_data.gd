...
func createWorld(_total_systems: int, _max_jumps: int, _hull_stress_wormhole: int, _hull_stress_CME: int, _SA_chance_per_candidate: float, _PA_chance_per_planet: float, _missing_AO_chance_per_planet: float, _missing_GL_chance_per_relevant_planet: float) -> worldAPI:
