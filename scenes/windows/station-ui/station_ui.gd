...
const upgrade_data = {
	...
	playerAPI.UPGRADE_ID.STEALTH_COMPOSITES: {"cost": 15000, "description": "An outer hull coating that is designed to absorb electromagnetic radiation.\n[ -6.25 scanner profile ]"},
