...
var draw_landmarks: Dictionary = {"The Core": systems_to_distance(0), "The Frontier": systems_to_distance(5), "The Abyss": systems_to_distance(15), "The Norma Outskirts": systems_to_distance(25)}
