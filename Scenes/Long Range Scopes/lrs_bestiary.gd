...
const ENTITY_CLASSIFICATION_DESCRIPTIONS = {
	...
	game_data.ENTITY_CLASSIFICATIONS.LAGRANGE_CLOUD: "gwub gwub"
}
...
const ENTITY_CLASSIFICATION_REWARD_WIDGETS = {
	...
	game_data.ENTITY_CLASSIFICATIONS.LAGRANGE_CLOUD: {"LONG SHOT (500)": null, "SUBJECTS AROUND FOCAL POINT": null}
}
