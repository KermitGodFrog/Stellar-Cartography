...
##On interaction (theorised, orbiting, following), the game will set this as the value of the 'custom_tag' fact, if configured. Leave empty to let the game search for more complex queries derived from the body type.
