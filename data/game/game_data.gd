...
enum ENTITY_CLASSIFICATIONS {SPACE_WHALE_POD, LAGRANGE_CLOUD, OLM_MAELSTROM} 
const ENTITY_CLASSIFICATION_CURVES = {
	...
	ENTITY_CLASSIFICATIONS.OLM_MAELSTROM: preload("uid://cdjrsw257aw4l")
}

enum SPECIAL_ANOMALY_CLASSIFICATIONS {NONE, RIGGED_ASTEROID, RIFT_DRIVER, NETSPACE_RETRIEVAL_POINT, DYSON_SPHERE, LEVIATHAN}
const SPECIAL_ANOMALY_CLASSIFICATION_CURVES = {
	SPECIAL_ANOMALY_CLASSIFICATIONS.NONE: preload("uid://cyev8sdpb6npm"),
	SPECIAL_ANOMALY_CLASSIFICATIONS.RIGGED_ASTEROID: preload("uid://dp0kuawqk0fo4"),
	SPECIAL_ANOMALY_CLASSIFICATIONS.RIFT_DRIVER: preload("uid://1uqqntwjk8ww"),
	SPECIAL_ANOMALY_CLASSIFICATIONS.NETSPACE_RETRIEVAL_POINT: preload("uid://dm0ye1ho1pt0f"),
	SPECIAL_ANOMALY_CLASSIFICATIONS.DYSON_SPHERE: preload("uid://q6l0xqns76db"),
	SPECIAL_ANOMALY_CLASSIFICATIONS.LEVIATHAN: preload("uid://ctrctnjfgclp")
}

enum SPECIAL_SYSTEM_CLASSIFICATIONS {NONE, VOID, INSA, DYSON_SPHERE, SKALIQ_PRESENCE, SKALIQ_CIVILIZED, MARAUDER_FLEET, GREEN_STAR, LIGHT_GREMLIN_PRESENCE}
const SPECIAL_SYSTEM_CLASSIFICATION_CURVES = {
	...
	SPECIAL_SYSTEM_CLASSIFICATIONS.MARAUDER_FLEET: preload("uid://dxb6bklol7ahm"),
	SPECIAL_SYSTEM_CLASSIFICATIONS.GREEN_STAR: preload("uid://ce7bsm3suc1wf"),
	SPECIAL_SYSTEM_CLASSIFICATIONS.LIGHT_GREMLIN_PRESENCE: preload("uid://kqr14juee3pn")
}
...
const MUTATION_UNLOCK_LOSE_SCHEDULE: Dictionary = { #focus on positive mutations
	...
	3: [worldAPI.MUTATION_ID.BETTER_ENGINES]
}
...
func createWorld(_total_systems: int, _max_jumps: int, _hull_stress_wormhole: int, _hull_stress_CME: int, _hull_stress_pulsar_beam: int, _hull_stress_mine: int, _scanner_profile: float, _scanner_power: float, _SA_chance_per_candidate: float, _PA_chance_per_planet: float, _missing_AO_chance_per_planet: float, _missing_GL_chance_per_relevant_planet: float) -> worldAPI:
	...
	world.missing_GL_chance_per_relevant_planet = _missing_GL_chance_per_relevant_planet
	return world
